...
class CountiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create county" do
    assert_difference('County.count') do
      post counties_url, params: { county: { name: @county.name, state_id: @county.state_id } }
    end
  ...
  test "should update county" do
    patch county_url(@county), params: { county: { name: @county.name, state_id: @county.state_id } }
